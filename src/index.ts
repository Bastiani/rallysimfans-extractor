...
//   const result = await scrapeOnlineRallyResultsTable('82917');
//   const resultTop = JSON.stringify(result.slice(0, 9), null, 2);
//   const generatedMsg = await generateMessageForRallyResults(resultTop, `https://rallysimfans.hu/rbr/rally_online.php?centerbox=rally_results.php&rally_id=82917`);
